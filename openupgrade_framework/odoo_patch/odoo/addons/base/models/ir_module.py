...
def check_external_dependencies(self, module_name, newstate='to install'):
    try:
        IrModuleModule.check_external_dependencies._original_method(self, module_name, newstate=newstate)
...
check_external_dependencies._original_method = IrModuleModule.check_external_dependencies
